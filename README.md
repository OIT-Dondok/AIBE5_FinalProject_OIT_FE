...
| 이름 | 역할 |
|------|------|
| 김세희 (A) | 인증 피드 탭 UI · 이모지 리액션 UI · 대시보드 UI · 정산 모달 UI |
| 서일현 (B) | 크루 상세 탭 구조 · 도딘 잔액/내역 |
| 문창현 (C) | JWT axios 인터셉터 · 프로필 · 방장 검증 · FCM · html2canvas |
| 김한비 (D) | FE 공통 구조 셋업 · 문서 · 검증내역 탭 · 운영 콘솔 탭 · FCM 웹 푸시 UI |
| 전성 (E) | Next.js 초기화 · Vercel 배포 · 공통 컴포넌트 · 크루 생성/탐색/목록 · 입장 신청·신청자 관리 UI |
