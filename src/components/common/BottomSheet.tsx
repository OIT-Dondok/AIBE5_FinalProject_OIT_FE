    ...
    return createPortal(
        <div className="fixed inset-0 z-[60] flex items-end justify-center">
            ...
            <div
                ...
                className={`relative z-10 w-full max-w-[430px] rounded-t-3xl shadow-[var(--shadow-card-elevated)] animate-in slide-in-from-bottom duration-300 ${panelClassName}`}
            >
                {/* 드래그 핸들 */}
                ...
                {title && (
                    <div
                        className={`flex items-center justify-between px-5 py-3 ${
                            showHeaderBorder ? "border-b border-text-secondary/[0.08]" : ""
                        }`}
                    >
                        <div>
